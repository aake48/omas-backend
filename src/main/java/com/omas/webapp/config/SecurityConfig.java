	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(csrf -> csrf.disable())
            .authorizeHttpRequests(requests -> requests
                .requestMatchers("/api/reg", "/api/login", "/api/forgot_password","/api/reset_password" , "/api/club/**", "/api/competition/**", "/api/competition/active/query/**", "/api/score/**", "api/competition/team/**", "api/competition/team/active/query/**","api/competition/team/query/**").permitAll())
